...
<body class="min-h-screen flex items-center justify-center p-4 college-bg">

    <div class="w-full max-w-4xl flex overflow-hidden rounded-2xl shadow-2xl">
        <!-- Left Side -->
        <div class="hidden md:flex flex-1 bg-blue-900 relative overflow-hidden">
            <div class="absolute inset-0 bg-gradient-to-t from-college-blue to-transparent opacity-90"></div>
            <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80" 
                 alt="College Campus" 
        ...
        <div class="w-full md:w-1/2 bg-white p-10 flex flex-col justify-center">
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold text-gray-800 mb-2">Login Page</h2>
            ...
            <form method="POST" action="{{ url('/login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email"
                            class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-college-blue focus:border-college-blue focus:outline-none transition"
                            placeholder="Enter your E-mail" required value="{{ old('email') }}">
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    {{-- <a href="#" class="text-sm font-medium text-college-blue hover:text-college-accent">Forgot password?</a> --}}
                </div>

                <div>
                    <button type="submit"
                        class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-lg font-medium text-white bg-college-blue hover:bg-college-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-college-blue transition transform hover:-translate-y-0.5">
                        Sign In
                    </button>
                </div>
            </form>
            ...
            <div class="mt-8 text-center text-sm text-gray-600">
                <p>Don't have an account?
                    <a href="{{ route('student.register.form') }}" class="font-medium text-college-blue hover:text-college-accent">Register</a>
