...
<head>
    ...
    <title>Canteen Dashboard - College Complaint System</title>
...
<body class="min-h-screen flex">
    ...
    <div id="sidebar" class="sidebar sidebar-bg w-64 min-h-screen flex-shrink-0 hidden md:block">
        <div class="p-4 flex items-center space-x-3 border-b border-blue-800">
            ...
            <div>
                <h2 class="font-bold">Canteen Panel</h2>
                <p class="text-xs text-blue-200">College Complaint System</p>
            </div>
        </div>
        
        <nav class="p-4 space-y-1">
            <a href="{{ url('/canteen/dashboard') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg nav-link active">
    ...
    <div class="flex-1 overflow-x-hidden">
        ...
        <div class="md:hidden flex justify-between items-center p-4 bg-blue-800 text-white">
            ...
            <h1 class="text-xl font-bold">Canteen Dashboard</h1>
        ...
        <div class="container mx-auto px-4 py-6 max-w-7xl">
            ...
            <div class="mb-8 flex justify-between items-center header-bg rounded-xl p-6 shadow-md hidden md:flex">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white">Canteen Dashboard</h1>
                        <p class="text-blue-100">Manage food-related complaints</p>
                    </div>
                </div>
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        <h2 class="text-xl font-bold">
                            <i class="fas fa-clipboard-list mr-2"></i> Food Complaints
                        </h2>
                        <form method="GET" action="{{ url('/canteen/dashboard') }}" class="flex items-center space-x-2">
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-gray-200 table-row-hover">
                                    ...
                                    <td class="p-3">
                                        <a href="{{ url('/canteen/complaint/' . $complaint->id) }}" class="text-blue-600 hover:text-blue-800">
